...
TwinStickShooter_CPPRootPath=/media/bat/SecondSSD/Projects/Unreal/TwinStickShooter_CPP

gameProjectFile=/media/bat/SecondSSD/Projects/Unreal/TwinStickShooter_CPP/TwinStickShooter_CPP.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(TwinStickShooter_CPPSource.pri)
include(TwinStickShooter_CPPHeader.pri)
include(TwinStickShooter_CPPConfig.pri)
include(TwinStickShooter_CPPIncludes.pri)
include(TwinStickShooter_CPPDefines.pri)
...
TwinStickShooter_CPP-Linux-Debug.commands = $$build TwinStickShooter_CPP Linux Debug  -project="\"$$gameProjectFile\"" $$args
TwinStickShooter_CPP-Linux-DebugGame.commands = $$build TwinStickShooter_CPP Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
TwinStickShooter_CPP-Linux-Shipping.commands = $$build TwinStickShooter_CPP Linux Shipping  -project="\"$$gameProjectFile\"" $$args
TwinStickShooter_CPP-Linux-Test.commands = $$build TwinStickShooter_CPP Linux Test  -project="\"$$gameProjectFile\"" $$args
TwinStickShooter_CPP.commands = $$build TwinStickShooter_CPP Linux Development  -project="\"$$gameProjectFile\"" $$args

TwinStickShooter_CPPEditor-Linux-Debug.commands = $$build TwinStickShooter_CPPEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
TwinStickShooter_CPPEditor-Linux-DebugGame.commands = $$build TwinStickShooter_CPPEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
TwinStickShooter_CPPEditor-Linux-Shipping.commands = $$build TwinStickShooter_CPPEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
TwinStickShooter_CPPEditor-Linux-Test.commands = $$build TwinStickShooter_CPPEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
TwinStickShooter_CPPEditor.commands = $$build TwinStickShooter_CPPEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	TwinStickShooter_CPP-Linux-Debug \
	TwinStickShooter_CPP-Linux-DebugGame \
	TwinStickShooter_CPP-Linux-Shipping \
	TwinStickShooter_CPP-Linux-Test \
	TwinStickShooter_CPP \
	TwinStickShooter_CPPEditor-Linux-Debug \
	TwinStickShooter_CPPEditor-Linux-DebugGame \
	TwinStickShooter_CPPEditor-Linux-Shipping \
	TwinStickShooter_CPPEditor-Linux-Test \
	TwinStickShooter_CPPEditor \
